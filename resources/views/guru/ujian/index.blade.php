  ...
  <div class="main">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            {{ $u->guruMapelKelas->kelas->nama_kelas ?? '-' }}
            -
            {{ $u->guruMapelKelas->mapel->nama_mapel ?? '-' }}
          </td>
          <td>{{ $u->acak_soal ? '✅' : '❌' }}</td>
          <td>
            {{-- Tambah Soal --}}
            ...
            {{-- Edit --}}
            <button type="button" class="btn-edit" onclick="editUjian({{ $u->id }})">✏️</button>
    ...
    <style>
      .modal {
        ...
        align-items: center;
        /* biar modal-content di tengah vertikal */
