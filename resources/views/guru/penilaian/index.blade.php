...
<body>
  ...
  @endif
    ...
    <div class="card-container">
      ...
      <td>
      <input type="number" step="0.01" name="nilai[{{ $i }}][tugas]" class="form-control"
      value="{{ $p->nilai_tugas }}">
      </td>
      <td>
      <input type="number" step="0.01" name="nilai[{{ $i }}][kuis]" class="form-control"
      value="{{ $p->nilai_kuis }}">
      </td>
      <td>
      <input type="number" step="0.01" name="nilai[{{ $i }}][uts]" class="form-control"
      value="{{ $p->nilai_uts }}">
      </td>
      <td>
      <input type="number" step="0.01" name="nilai[{{ $i }}][uas]" class="form-control"
      value="{{ $p->nilai_uas }}">
      </td>
      <td>
