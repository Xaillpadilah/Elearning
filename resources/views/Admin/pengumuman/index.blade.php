...
<body>
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="{{ route('admin.mapel.index') }}">📘 Materi</a></li>
  ...
  <div class="main">
    ...
    <div class="info-frame">
      ...
      <p>Buat dan kelola pengumuman untuk guru, siswa, dan orang tua melalui sistem ini.</p>
    </div>

    <div class="actions">
      <button class="btn-tambah" onclick="document.getElementById('modalTambah').style.display='flex'">➕ Tambah Pengumuman</button>
    </div>

    <form class="search-form" method="GET" action="{{ route('admin.pengumuman') }}">
      <input type="text" name="search" placeholder="Cari pengumuman..." value="{{ $search ?? '' }}">
    ...
    <table>
      ...
      <tbody>
        ...
        @empty
        <tr>
          <td colspan="6" style="text-align:center; padding:20px;">Tidak ada pengumuman ditemukan.</td>
        </tr>
        @endforelse
      </tbody>
    </table>
  ...
  <div class="modal" id="modalTambah">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('admin.pengumuman.store') }}">
        ...
        <textarea name="isi" placeholder="Isi Pengumuman" required style="width:100%; height:100px; border-radius:8px; padding:10px; margin-bottom:12px; border:1px solid #ccc;"></textarea>
  ...
  <footer>
    &copy; {{ date('Y') }} E-Learning SMP 5 CIDAUN - Kelola Pengumuman Sekolah.
  </footer>
