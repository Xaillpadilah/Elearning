...
<body>
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="{{ route('admin.kelas') }}" class="active">🏫 Data Kelas</a></li>
  ...
  <div class="main">
    ...
    <div class="actions">
      <button class="btn-tambah" onclick="document.getElementById('modalTambahKelas').style.display='flex'">➕ Tambah Kelas</button>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button class="btn-edit" onclick="openEditModal({{ $item->id }}, '{{ $item->nama_kelas }}', '{{ $item->wali_kelas }}', '{{ $item->jumlah_siswa }}')">✏️ Edit</button>
          </td>
        </tr>
        @endforeach
      </tbody>
  ...
  <!-- Modal Tambah Kelas -->
  @include('admin.kelas.createk')

  <!-- Modal Edit Kelas -->
  @include('admin.kelas.editk')
  ...
  <script>
    ...
    function openEditModal(id, nama_kelas, wali_kelas, jumlah_siswa) {
      const modal = document.getElementById('modalEditKelas');
      modal.style.display = 'flex';
      document.getElementById('edit-nama-kelas').value = nama_kelas;
      document.getElementById('edit-wali-kelas').value = wali_kelas;
      document.getElementById('edit-jumlah-siswa').value = jumlah_siswa;
    ...
    window.onclick = function(event) {
      if (event.target === document.getElementById('modalEditKelas') || event.target === document.getElementById('modalTambahKelas')) {
