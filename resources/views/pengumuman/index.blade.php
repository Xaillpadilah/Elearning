...
<div class="sidebar">
  ...
  <ul>
    ...
    <li><a href="{{ route('materi.index') }}">📚 Mata Pelajaran</a></li>
...
<div class="main">
  ...
  <div class="actions">
    <button class="btn-tambah" onclick="document.getElementById('modalTambahPengumuman').style.display='flex'">➕ Tambah Pengumuman</button>
  </div>
...
<footer>&copy; {{ date('Y') }} E-Learning SMP 5 CIDAUN - Dashboard Admin.</footer>
