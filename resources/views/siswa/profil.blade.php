    ...
    <div class="max-w-5xl mx-auto mt-10 p-6 bg-white rounded-xl shadow-md">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center space-x-4">
                <a href="{{ route('siswa.siswadashboard') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded">
                    ← Kembali
                </a>
                <h2 class="text-2xl font-bold text-gray-800">Profil Siswa</h2>
            </div>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-2/3">
                <form method="POST" action="{{ route('siswa.profil.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ $siswa->kelas->nama_kelas ?? '-' }}" disabled
                            class="w-full px-4 py-2 border rounded bg-gray-100 text-gray-600">
                    </div>
            ...
            <div class="md:w-1/3 flex flex-col items-center justify-center text-center border-t md:border-t-0 md:border-l border-gray-200 pt-6 md:pt-0 md:pl-6">
              ...
              <img src="{{ $user->foto ? asset('storage/' . $user->foto) : asset('default.png') }}"
     alt="Foto Profil"
