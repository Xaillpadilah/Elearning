...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li><a href="{{ route('siswa.absensi.index') }}" class="active">📋 Absensi</a></li>
...
<div class="main" id="main-content">
    ...
    <p>Anda dapat melihat data kehadiran yang telah dicatat oleh guru. Pastikan semua data sesuai dengan kehadiran Anda.</p>
</div>
